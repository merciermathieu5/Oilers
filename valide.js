/* Harnais de validation — Oilers d’Edmonton (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'EDMONTON',
  taille: 23,
  echantillon: {nom: 'Leon Draisaitl', salaire: 13125000, ct: 0, ov: 84},
  masseSousContrat: 38225000,
  nbSousContrat: 8,
  dateSecours: '8 juillet 2026',
  nbEchus: 15,
  nbBackups: 0,
  masseTotale: 104325000
};
...
(async () => {
  ...
  W.localStorage.removeItem('edm_resignatures_v1');
  W.localStorage.removeItem('edm_transac_v1');
